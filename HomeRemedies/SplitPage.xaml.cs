...
namespace HomeRemedies
{
    ...
    /// </summary>
    public sealed partial class SplitPage : HomeRemedies.Common.LayoutAwarePage
    {
        ...
        protected bool GetShareContent(DataRequest request)
        {
            ...
            string dataPackageText = remedydesc1.Text + "\n" + remedydesc2.Text + "*** To know more download Home Medications from the Windows Store.";
            if (!String.IsNullOrEmpty(dataPackageText))
            {
                DataPackage requestData = request.Data;
                requestData.Properties.Title = "Home Medication - " + diseasename.Text;
                requestData.Properties.Description = "Home Medication - " + remedyname.Text; // The description is optional.
                requestData.SetHtmlFormat(dataPackageText);
